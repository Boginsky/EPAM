...
public class SubmitOrderCommand implements Command {
    ...
    public Router execute(HttpServletRequest httpServletRequest) throws CommandException {
        ...
        submitOrder(httpSession, listOfSongsInCart, user, moneyForPayment, bonusForPayment, totalPrice);
        Router router = new Router();
        router.setRedirect();
        return router;
    }

    private void submitOrder(HttpSession httpSession, Set<Song> listOfSongsInCart, User user, BigDecimal moneyForPayment, BigDecimal bonusForPayment, BigDecimal totalPrice) throws CommandException {
