...
public class AllSongsForAlbumCommand implements Command {
    ...
    private String getPage(HttpServletRequest httpServletRequest, SongService songService, AlbumService albumService, CommentService commentService, Long albumId) throws CommandException {
        ...
        try {
            ...
            logger.error("Exception in all album song command", e);
            throw new CommandException("Exception in all album song command", e);
        }
        return page;
    }
}
