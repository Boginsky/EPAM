...
<html>
<head>
    <title><fmt:message key="label.changeEmailConfirm" bundle="${var}"/></title>
        ...
        <div class="card-body">
            <form action="./controller" name="command" method="post">
                ...
                <div class="text-center">
                    <input type="hidden" name="command" value="change_email_confirm"/>
                    <input type="hidden" name="realConfirmCode" value="${realConfirmCode}">
                    <input type="hidden" name="updatedEmail" value="${updatedEmail}">
