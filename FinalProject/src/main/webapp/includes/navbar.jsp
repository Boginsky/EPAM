<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="./controller?command=all_songs"><fmt:message key="label.main" bundle="${var}"/></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            <c:choose>
                ...
                <c:otherwise>
                    <li class="nav-item"><a class="nav-link" href="./controller?command=sign_up"><fmt:message
                            key="label.signUp"
                            bundle="${var}"/></a>
                    </li>
