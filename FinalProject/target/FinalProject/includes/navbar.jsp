            ...
            <c:when test="${user.firstName != null}">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href=""><fmt:message key="label.cart" bundle="${var}"/></a>
                        <a class="dropdown-item" href=""><fmt:message key="label.orders" bundle="${var}"/></a>
                        <a class="dropdown-item" href="./controller?command=cabinet"><fmt:message key="label.cabinet"
                                                                                                  bundle="${var}"/></a>
